                                ...
                                <form action="{{ route('distributor.update', $distributor->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control phone-number" name="no_telp"
                                                value="{{ old('no_telp', $distributor->no_telp) }}" required pattern="^[0-9]{13,15}$" title="No telp harus terdiri dari 13-15 angka">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alamat"
                                            value="{{ old('alamat', $distributor->alamat) }}" required>
                                    </div>
